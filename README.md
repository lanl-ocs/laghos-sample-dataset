...
This sample dataset is generated by running the open source Laghos miniapp using a single MPI process on a single node with result rewritten into Apache Parquet. A total of 524,287 mesh elements, 612,310 vertices, and 4,194,304 data points were simulated and recorded. The command used to run Laghos is `mpirun -np 32 ./laghos -p 3 -m data/box01_hex.mesh -rs 2 -rp 3 -tf 5.0 -pa -visit -print -k <datadir>`.
